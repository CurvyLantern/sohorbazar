...
const ProductCard2 = () => {
    return (
        <div className="border-1px rounded-sm border">
            <div className=" flex gap-5 p-4">
                <div className="relative w-1/2 overflow-hidden rounded-sm">
                    <img
                        src="https://i.ibb.co/MffxLzR/pexels-pixabay-164446.jpg"
                        alt="product-image"
                        className="h-full w-full rounded-sm object-cover"
                    />
                    <p className="absolute left-0 top-0 h-[24px] w-[74px] flex-1 bg-rose-600 text-center text-white">
                        15% off
                    </p>
                </div>
                <div className="w-1/2">
                    <div>
                        ...
                        <div className="flex items-center">
                            ...
                            <span className="font- ml-2 flex items-center text-lg font-bold text-primary">
                                <svg
                                    xmlns="http://www.w3.org/2000/svg"
                                    height="16px"
                                    viewBox="0 0 384 512"
                    ...
                    <div className=" h-2 w-full rounded-full bg-gray-300">
                        <div className="h-2 w-3/4 rounded-full bg-teal-500"></div>
                    </div>
                    <p className="text-sm">Sold:32/70</p>
                </div>
            </div>
        </div>
    );
